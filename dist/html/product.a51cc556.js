...
})({"e2sTF":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "9e5010bda51cc556";
"use strict";
...
},{}],"ggjsj":[function(require,module,exports) {
...
window.onload = function() {
    ...
    let createtitle = document.getElementById("product-h1");
    createtitle.innerHTML = storageasobject.name;
    let createdescription = document.getElementById("product-description");
    createdescription.innerHTML = storageasobject.description;
    let createprice = document.getElementById("product-price-2");
    createprice.innerHTML = " " + storageasobject.amount.toString() + " ";
    let productPlusButton = document.getElementById("product-plus-button");
    productPlusButton.addEventListener("click", usePlusButton);
    let productMinusButton = document.getElementById("product-minus-button");
...
let homebtn = document.getElementById("product-house-icon");
homebtn.addEventListener("click", ()=>{
    window.location.href = "home.html";
});
let shopbtn = document.getElementById("product-shop-icon");
...
function sendToSeassionStorage() {
    let storageasobjectJson = JSON.stringify(storageasobject);
...
function addToCart() {
    ...
    if (cartArray.some((product)=>product.name === storageasobject.name
        ...
        let findProduct = cartArray.find((theProduct)=>theProduct.name === storageasobject.name
        );
...
function checkAmountOnOnload() {
    ...
    if (cartArray.some((amount)=>amount.name === storageasobject.name
        ...
        let find = cartArray.find((theAmount)=>theAmount.name === storageasobject.name
        );
...
function productsInCartArrayCounter() {
    ...
    let cartCount = document.getElementById("product-cart-counter");
    cartCount.innerHTML = totalItemsInArray.toString();
    if (totalItemsInArray > 0) cartCount.classList.add("visible");
}
function calculatePrice() {
    getFromSessionStorgage();
    let productQuantityPrice = document.getElementById("product-quantity-price");
    let totalPrice = storageasobject.amount * storageasobject.price;
    productQuantityPrice.innerHTML = "Total Price: $" + totalPrice.toString();
}
...
},{}]},["e2sTF","ggjsj"], "ggjsj", "parcelRequire8272")

//# sourceMappingURL=product.a51cc556.js.map
