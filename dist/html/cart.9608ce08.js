...
})({"dRvyP":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "d8d6915c9608ce08";
"use strict";
...
},{}],"crGKR":[function(require,module,exports) {
...
window.onload = function() {
    ...
    document.getElementById("cart-makeorder").addEventListener("click", goToCheckoutPage);
};
function createCartHtml() {
    let cartSectionWrapper = document.querySelector(".cart-section");
    getCartFromLocalStorage();
    calculateTotal();
    calculateVat();
...
function calculateVat() {
    ...
    let cartSetVValues = cartVValues;
    let vsum = 0;
...
function useMinusButton(i) {
    cartArray[i].amount--;
    if (cartArray[i].amount < 1) cartArray.splice(i, 1);
    sendToCartInLocalStorage();
    createCartHtml();
}
function usePlusButton(i) {
    cartArray[i].amount++;
    sendToCartInLocalStorage();
    createCartHtml();
}
...
},{}]},["dRvyP","crGKR"], "crGKR", "parcelRequire8272")

//# sourceMappingURL=cart.9608ce08.js.map
