...
})({"gXjhe":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "18166b05a46b4fd3";
"use strict";
...
},{}],"iaNT4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let astext1 = [];
window.onload = function() {
    document.getElementById("checkout-home").addEventListener("click", ()=>{
        console.log("hej");
...
function getfromstorage() {
    ...
    let fromstorage = localStorage.getItem("cartArray");
    let astext = JSON.parse(fromstorage);
    let productcontainer = document.getElementById("product-ckeckout-container");
    let amountcontainer = document.getElementById("amount-checkout-container2");
    let amounttext = document.createElement("th");
    amountcontainer.appendChild(amounttext);
    amounttext.innerHTML = "amount:";
    let titlecontainer = document.getElementById("title-container");
    titlecontainer.innerHTML = "<strong>products:</strong>";
    let productquantity = document.getElementById("product-quantity");
    let qttext = document.createElement("th");
    productquantity.appendChild(qttext);
    qttext.innerHTML = "change quantity:";
    let checkkouttotal2 = document.getElementById("title-total");
    let totaltext = document.createElement("th");
    checkkouttotal2.appendChild(totaltext);
    totaltext.innerHTML = "total:";
    for(let i = 0; i < astext.length; i++){
        let productt = document.createElement("th");
        titlecontainer.appendChild(productt);
        productt.innerHTML = astext[i].name;
        productt.className = "hej";
        let amountt = document.createElement("th");
        amountcontainer.appendChild(amountt);
        amountt.innerHTML = "x" + astext[i].amount;
        amountt.className = "hej";
        let amountqt = document.createElement("th");
        productquantity.appendChild(amountqt);
        let amountplusbtn = document.createElement("button");
    ...
    let addition = 0;
    for(let i1 = 0; i1 < astext.length; i1++)addition += astext[i1].price *= astext[i1].amount;
...
function addamount(i) {
    let fromstorage = localStorage.getItem("cartArray");
    let astext2 = JSON.parse(fromstorage);
    astext2[i].amount++;
...
function subtractamount(i) {
    ...
    let astext2 = JSON.parse(fromstorage);
    astext2[i].amount--;
    let titlecontainer2 = document.getElementById("title-container");
    let backtostorage = JSON.stringify(astext2);
    localStorage.setItem("cartArray", backtostorage);
    let productcontainer = document.getElementById("product-ckeckout-container");
    productcontainer.innerHTML = "";
...
},{}]},["gXjhe","iaNT4"], "iaNT4", "parcelRequire8272")

//# sourceMappingURL=checkout.a46b4fd3.js.map
