...
let porcelainFlower: Product = new Product(
  "Porcelain Flower",
  "../assets/Porcelain_flower_cropped.jpg",
...
let mixedCacti: Product = new Product(
  "Mixed Cacti",
  "../assets/Mixed_cacti_cropped.jpg",
...
let miniatureCactus: Product = new Product(
  "Miniature Cactus",
  "../assets/Miniature_cactus_cropped.jpg",
...
let fingerCactus: Product = new Product(
  "Finger Cactus",
  "../assets/finger_cactus_cropped.jpg",
